//
//  SoundsExposuresThreeViewController.swift
//  ERP
//
...
class SoundsExposuresThreeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var SoundThreeL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        SoundThreeL.text = UserDefaults.standard.object(forKey: "SoundThreeSaved") as? String
        if SoundThreeL.text != nil {
            UIPasteboard.general.string = SoundThreeL.text
        }
