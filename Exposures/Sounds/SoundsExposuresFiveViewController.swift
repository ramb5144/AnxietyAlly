//
//  SoundsExposuresFiveViewController.swift
//  ERP
//
...
class SoundsExposuresFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var SoundFiveL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        SoundFiveL.text = UserDefaults.standard.object(forKey: "SoundFiveSaved") as? String
        if SoundFiveL.text != nil {
            UIPasteboard.general.string = SoundFiveL.text
        }
