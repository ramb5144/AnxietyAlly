//
//  SoundsExposuresFourViewController.swift
//  ERP
//
...
class SoundsExposuresFourViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var SoundFourL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        SoundFourL.text = UserDefaults.standard.object(forKey: "SoundFourSaved") as? String
        if SoundFourL.text != nil {
            UIPasteboard.general.string = SoundFourL.text
        }
