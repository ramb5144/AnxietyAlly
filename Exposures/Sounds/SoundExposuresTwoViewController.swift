//
//  SoundExposuresTwoViewController.swift
//  ERP
//
...
class SoundExposuresTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var SoundTwoL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        SoundTwoL.text = UserDefaults.standard.object(forKey: "SoundTwoSaved") as? String
        if SoundTwoL.text != nil {
            UIPasteboard.general.string = SoundTwoL.text
        }
