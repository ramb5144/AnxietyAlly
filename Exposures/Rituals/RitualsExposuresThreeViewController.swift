//
//  RitualsExposuresThreeViewController.swift
//  ERP
//
...
class RitualsExposuresThreeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var RitualThreeL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        RitualThreeL.text = UserDefaults.standard.object(forKey: "RitualThreeSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if RitualThreeL.text != nil {
            UIPasteboard.general.string = RitualThreeL.text
        }
