//
//  RitualsExposuresFourViewController.swift
//  ERP
//
...
class RitualsExposuresFourViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var RitualFourL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        RitualFourL.text = UserDefaults.standard.object(forKey: "RitualFourSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if RitualFourL.text != nil {
            UIPasteboard.general.string = RitualFourL.text
        }
