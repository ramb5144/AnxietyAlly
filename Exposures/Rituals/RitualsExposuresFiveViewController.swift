//
//  RitualsExposuresFiveViewController.swift
//  ERP
//
...
class RitualsExposuresFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var RitualFiveL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        RitualFiveL.text = UserDefaults.standard.object(forKey: "RitualFiveSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if RitualFiveL.text != nil {
            UIPasteboard.general.string = RitualFiveL.text
        }
