//
//  RitualExposuresViewController.swift
//  ERP
//
...
class RitualExposuresViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var RitualL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        RitualL.text = UserDefaults.standard.object(forKey: "RitualOneSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if RitualL.text != nil {
            UIPasteboard.general.string = RitualL.text
        }
