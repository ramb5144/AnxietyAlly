//
//  RitualsExposuresTwoViewController.swift
//  ERP
//
...
class RitualsExposuresTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var RiualTwoL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        RiualTwoL.text = UserDefaults.standard.object(forKey: "RitualTwoSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if RiualTwoL.text != nil {
            UIPasteboard.general.string = RiualTwoL.text
        }
