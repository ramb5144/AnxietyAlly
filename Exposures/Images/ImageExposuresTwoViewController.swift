//
//  ImageExposuresTwoViewController.swift
//  ERP
//
...
class ImageExposuresTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var ImageTwoL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        ImageTwoL.text = UserDefaults.standard.object(forKey: "PictureTwoSaved") as? String
        if ImageTwoL.text != nil {
            UIPasteboard.general.string = ImageTwoL.text
        }
