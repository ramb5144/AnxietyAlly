//
//  ImageExposuresThreeViewController.swift
//  ERP
//
...
class ImageExposuresThreeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var PictureThreeL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        PictureThreeL.text = UserDefaults.standard.object(forKey: "PictureThreeSaved") as? String
        if PictureThreeL.text != nil {
            UIPasteboard.general.string = PictureThreeL.text
        }
