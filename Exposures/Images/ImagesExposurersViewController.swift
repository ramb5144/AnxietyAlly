//
//  ImagesExposurersViewController.swift
//  ERP
//
...
class ImagesExposurersViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var PictureL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        PictureL.text = UserDefaults.standard.object(forKey: "PictureOneSaved") as? String
        if PictureL.text != nil {
            UIPasteboard.general.string = PictureL.text
        }
