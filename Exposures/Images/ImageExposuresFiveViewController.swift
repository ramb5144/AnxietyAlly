//
//  ImageExposuresFiveViewController.swift
//  ERP
//
...
class ImageExposuresFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var PictureFiveL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        PictureFiveL.text = UserDefaults.standard.object(forKey: "PictureFiveSaved") as? String
        if PictureFiveL.text != nil {
            UIPasteboard.general.string = PictureFiveL.text
        }
