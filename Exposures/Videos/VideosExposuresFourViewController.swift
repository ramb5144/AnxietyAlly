//
//  VideosExposuresFourViewController.swift
//  ERP
//
...
class VideosExposuresFourViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var VideoFourL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        VideoFourL.text = UserDefaults.standard.object(forKey: "VideoFourSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if VideoFourL.text != nil {
            UIPasteboard.general.string = VideoFourL.text
        }
