//
//  VideosExposuresThreeViewController.swift
//  ERP
//
...
class VideosExposuresThreeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var VideoThreeL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        VideoThreeL.text = UserDefaults.standard.object(forKey: "VideoThreeSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if VideoThreeL.text != nil {
            UIPasteboard.general.string = VideoThreeL.text
        }
