//
//  VideosExposuresViewController.swift
//  ERP
//
...
class VideosExposuresViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        VideoL.text = UserDefaults.standard.object(forKey: "VideoOneSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if VideoL.text != nil {
            UIPasteboard.general.string = VideoL.text
        }
