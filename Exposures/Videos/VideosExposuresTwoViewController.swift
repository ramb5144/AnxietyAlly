//
//  VideosExposuresTwoViewController.swift
//  ERP
//
...
class VideosExposuresTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var VideoTwoL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        VideoTwoL.text = UserDefaults.standard.object(forKey: "VideoTwoSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if VideoTwoL.text != nil {
            UIPasteboard.general.string = VideoTwoL.text
        }
