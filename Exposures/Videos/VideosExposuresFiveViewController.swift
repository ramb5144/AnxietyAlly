//
//  VideosExposuresFiveViewController.swift
//  ERP
//
...
class VideosExposuresFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var VideoFiveL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        VideoFiveL.text = UserDefaults.standard.object(forKey: "VideoFiveSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if VideoFiveL.text != nil {
            UIPasteboard.general.string = VideoFiveL.text
        }
