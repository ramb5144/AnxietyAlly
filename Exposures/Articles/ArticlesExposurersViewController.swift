//
//  ArticlesExposurersViewController.swift
//  ERP
//
...
class ArticlesExposurersViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var ArticleL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ArticleL.text = UserDefaults.standard.object(forKey: "ArticleOneSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if ArticleL.text != nil {
            UIPasteboard.general.string = ArticleL.text
        }
