//
//  ArticlesTwoViewController.swift
//  ERP
//
...
class ArticlesTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var ArticleTwoL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ArticleTwoL.text = UserDefaults.standard.object(forKey: "ArticleTwoSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if ArticleTwoL.text != nil {
            UIPasteboard.general.string = ArticleTwoL.text
        }
