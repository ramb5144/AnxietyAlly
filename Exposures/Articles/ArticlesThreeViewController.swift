//
//  ArticlesThreeViewController.swift
//  ERP
//
...
class ArticlesThreeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var ArticleThreeL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ArticleThreeL.text = UserDefaults.standard.object(forKey: "ArticleThreeSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if ArticleThreeL.text != nil {
            UIPasteboard.general.string = ArticleThreeL.text
        }
