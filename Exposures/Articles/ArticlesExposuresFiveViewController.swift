//
//  ArticlesExposuresFiveViewController.swift
//  ERP
//
...
class ArticlesExposuresFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var ArticleFiveL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ArticleFiveL.text = UserDefaults.standard.object(forKey: "ArticleFiveSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if ArticleFiveL.text != nil {
            UIPasteboard.general.string = ArticleFiveL.text
        }
