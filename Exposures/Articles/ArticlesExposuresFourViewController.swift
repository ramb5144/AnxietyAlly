//
//  ArticlesExposuresFourViewController.swift
//  ERP
//
...
class ArticlesExposuresFourViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var ArticleFourL: UILabel!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ArticleFourL.text = UserDefaults.standard.object(forKey: "ArticleFourSaved") as? String
        let toolBar = UIToolbar()
        toolBar.sizeToFit()
        if ArticleFourL.text != nil {
            UIPasteboard.general.string = ArticleFourL.text
        }
