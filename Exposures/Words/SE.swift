//
//  WordsExposureViewController.swift
//  ERP
//
...
class WordsExposureViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var WordExposuresLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        WordExposuresLabel.text = UserDefaults.standard.object(forKey: "WordOneSaved") as? String
        if WordExposuresLabel.text != nil {
            UIPasteboard.general.string = WordExposuresLabel.text
        }
