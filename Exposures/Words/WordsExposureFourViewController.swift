...
class WordsExposureFourViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var WordFourL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        WordFourL.text = UserDefaults.standard.object(forKey: "WordFourSaved") as? String
        if WordFourL.text != nil {
            UIPasteboard.general.string = WordFourL.text
        }
