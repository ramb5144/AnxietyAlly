...
class WordsExposureTwoViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var WordTwoL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        WordTwoL.text = UserDefaults.standard.object(forKey: "WordTwoSaved") as? String
        if WordTwoL.text != nil {
            UIPasteboard.general.string = WordTwoL.text
        }
