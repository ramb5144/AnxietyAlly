...
class WordsExposureThreeViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var WordThreeL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        WordThreeL.text = UserDefaults.standard.object(forKey: "WordThreeSaved") as? String
        if WordThreeL.text != nil {
            UIPasteboard.general.string = WordThreeL.text
        }
