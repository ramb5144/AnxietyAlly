...
class WordsExposureFiveViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var WordFiveL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        WordFiveL.text = UserDefaults.standard.object(forKey: "WordFiveSaved") as? String
        if WordFiveL.text != nil {
            UIPasteboard.general.string = WordFiveL.text
        }
